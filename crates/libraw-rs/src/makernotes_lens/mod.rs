...
impl MakernotesLens {
    ...
    impl_property!(min_ap4_min_focal, MinAp4MinFocal, f32);
    impl_property!(min_ap4_max_focal, MinAp4MaxFocal, f32);
    impl_property!(max_ap, MaxAp, f32);
    impl_property!(min_ap, MinAp, f32);
    impl_property!(cur_focal, CurFocal, f32);
    impl_property!(cur_ap, CurAp, f32);
    impl_property!(max_ap4_cur_focal, MaxAp4CurFocal, f32);
    impl_property!(min_ap4_cur_focal, MinAp4CurFocal, f32);
    impl_property!(min_focus_distance, MinFocusDistance, f32);
    impl_property!(focus_range_index, FocusRangeIndex, f32);
    impl_property!(lens_f_stops, LensFStops, f32);
